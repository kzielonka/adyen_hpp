...
class AdyenHppPaymentFieldsMerchantReferenceFieldTest < Minitest::Test
  ...
  def test_field_name
    assert_equal 'merchant_reference', AdyenHpp::PaymentFields::MerchantReferenceField.field_name
  end

  def test_adyen_field_name
    assert_equal 'merchantReference', AdyenHpp::PaymentFields::MerchantReferenceField.adyen_field_name
  end
