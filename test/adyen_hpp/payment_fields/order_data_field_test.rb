...
class AdyenHppPaymentFieldsOrderDataFieldTest < Minitest::Test
  def setup
    @class = AdyenHpp::PaymentFields::OrderDataField
    @field = @class.new
  end

  def test_field_name
    assert_equal 'order_data', @class.field_name
  end

  def test_adyen_field_name
    assert_equal 'orderData', @class.adyen_field_name
  end
