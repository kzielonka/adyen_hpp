...
class AdyenHppPaymentFieldsShopperReferenceFieldTest < Minitest::Test
  class ValidObject
    def to_str
      'some string'
    end
  ...
  def setup
    @class = AdyenHpp::PaymentFields::ShopperReferenceField
    @field = @class.new
  end

  def test_field_name
    assert_equal 'shopper_reference', @class.field_name
  end

  def test_adyen_field_name
    assert_equal 'shopperReference', @class.adyen_field_name
  end
